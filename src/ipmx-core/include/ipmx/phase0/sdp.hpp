...
[[nodiscard]] std::string make_phase0_sdp(const SdpSettings& settings,
                                          const NalUnit& sps,
                                          const NalUnit& pps);
void write_phase0_sdp(const std::filesystem::path& path,
                      const SdpSettings& settings,
                      const NalUnit& sps,
                      const NalUnit& pps);
[[nodiscard]] SdpSettings read_phase0_sdp(const std::filesystem::path& path);
